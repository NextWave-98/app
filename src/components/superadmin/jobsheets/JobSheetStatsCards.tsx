...
export default function JobSheetStatsCards({ stats }: JobSheetStatsCardsProps) {
  ...
  const statCards = [
    ...
    {
      title: 'Total Revenue',
     value: `USD ${formatCurrency(stats.totalAdvancePayments)}`,
      subtitle: `This Month: USD ${formatCurrency(stats.monthlyRevenue)}`,
      icon: DollarSign,
      color: 'bg-green-500',
    ...
    //   value: `USD ${formatCurrency(stats.totalAdvancePayments)}`,
    //   subtitle: `This Month: USD ${formatCurrency(stats.monthlyAdvancePayments)}`,
    //   icon: TrendingUp,
    //   color: 'bg-purple-500',
    ...
    {
      title: 'Balance Due',
      value: `USD ${formatCurrency(stats.totalDueBalance)}`,
      subtitle: `This Month: USD ${formatCurrency(stats.monthlyDueBalance)}`,
      icon: AlertCircle,
      color: 'bg-orange-500',
      textColor: 'text-orange-600',
      bgLight: 'bg-orange-50',
